namespace Nancy.Bootstrappers.DryIoc.Tests
{
    ...
    public class DryIocNancyBootstrapperFixture : IDisposable
    {
        private readonly FakeDryIocNancyBootstrapper bootstrapper;

        public DryIocNancyBootstrapperFixture()
        {
            this.bootstrapper = new FakeDryIocNancyBootstrapper();
